...
A live demo is automatically deployed to **GitHub Pages** on every push to `master` via [`.github/workflows/deploy-pages.yml`](.github/workflows/deploy-pages.yml). The demo UI loads when you supply the URL of an exported model directory.
